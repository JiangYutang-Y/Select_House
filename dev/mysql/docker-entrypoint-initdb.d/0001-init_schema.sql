...
CREATE TABLE `house`
(
    `id`                 bigint(20) unsigned NOT NULL COMMENT 'house唯一标识',
...
VALUES ('15', '富力城 国贸CBD 时尚休闲 商务办公', '6200', '70', '2', '10', '20', '2', '2005', '1',
        '2017-09-06 18:56:14', '2023-05-03 11:13:46', 'bj', 'hdq', 'Fhxz_c16YmEmIz5UVxrp6ihwbvCk', '2', '10', '1',
        '融泽嘉园', '2', '0', '龙域西二路');
INSERT INTO `house`
VALUES ('16', '富力城 国贸CBD 时尚休闲 商务办公', '6300', '70', '2', '10', '20', '0', '2012', '1',
        '2017-09-06 19:53:35', '2023-05-03 11:13:42', 'bj', 'hdq', 'FvkO1FFyGbrxCP_1O9tA94u2qvbP', '1', '-1', '1',
        '融泽嘉园', '2', '0', '龙域西二路');
INSERT INTO `house`
VALUES ('17', '二环东直门地铁站附近、王府井、天安门、国贸、三里屯、南锣鼓巷', '3000', '35', '1', '5', '10', '2', '2013', '1',
        '2017-09-06 20:45:35', '2023-05-03 11:13:36', 'bj', 'hdq', 'FpVYJRsLykrBRyUSCEOeqsqWU-bt', '1', '200', '0',
        '融泽嘉园', '2', '0', '龙域西二路');
INSERT INTO `house`
VALUES ('18', '华贸城 东向一居挑空loft 干净温馨 随时可以签约', '5700', '52', '1', '7', '20', '0', '2012', '1',
        '2017-09-06 21:01:02', '2023-05-03 11:13:30', 'bj', 'hdq', 'Fl1lNikhmMIecbTn-JTsurxugtFU', '2', '1085', '1',
        '融泽嘉园', '2', '0', '龙域西二路');
INSERT INTO `house`
VALUES ('19', '望春园板楼三居室 自住精装 南北通透 采光好视野棒！', '9200', '132', '3', '6', '14', '0', '2005', '1',
        '2017-09-06 22:44:25', '2023-05-03 11:13:25', 'bj', 'hdq', 'Fp1xPKVYtPsCeVHVQVW0Hif2FXk7', '2', '1108', '2',
        '融泽嘉园', '2', '0', '龙域西二路');
INSERT INTO `house`
VALUES ('20', '高大上的整租两居室 业主诚意出租', '5400', '56', '2', '12', '20', '0', '2012', '1', '2017-09-06 23:39:50',
        '2023-05-03 11:13:20', 'bj', 'hdq', 'FvVqU8LneZZ5xaLBAOM1KXR2Pz1X', '2', '-1', '1', '融泽嘉园', '2', '0',
        '龙域西二路');
INSERT INTO `house`
VALUES ('21', '新康园 正规三居室 精装修 家电家具齐全', '1900', '18', '1', '13', '25', '0', '2012', '1',
        '2017-09-07 00:52:47', '2023-05-03 11:13:15', 'bj', 'hdq', 'FnuOFbFtDYTbpPdFoZthR-R0tszC', '3', '1302', '0',
        '融泽嘉园', '2', '0', '龙域西二路');
INSERT INTO `house`
VALUES ('24', '湖光壹号望京华府183-387㎡阔景大宅', '50000', '288', '5', '1', '1', '0', '2015', '1',
        '2017-09-07 11:42:20', '2023-05-03 11:13:10', 'bj', 'hdq', 'FvVqU8LneZZ5xaLBAOM1KXR2Pz1X', '5', '200', '3',
        '融泽嘉园', '2', '0', '龙域西二路');
INSERT INTO `house`
VALUES ('25', '测试房源-编辑', '3000', '59', '2', '10', '20', '0', '2010', '3', '2017-10-28 22:34:48',
        '2017-11-11 12:22:50', 'bj', 'cpq', 'FtbxR2LY98lnnX_TPOgOPzti3k7G', '2', '1000', '1', '融泽嘉园', '2', '0',
        '龙域中街');
...
VALUES ('68', '19', 'http://xxx.cdn.com/', '911', '683', null, 'Fp1xPKVYtPsCeVHVQVW0Hif2FXk7'),
       ('69', '19', 'http://xxx.cdn.com/', '1012', '683', null, 'Fn371N5gLsJvjuIRC4IHjPtMy61h'),
       ('70', '24', 'http://xxx.cdn.com/', '1280', '960', null, 'Fn1AGNmZfadCIVTJA33gByg6a33B'),
       ('71', '24', 'http://xxx.cdn.com/', '1024', '683', null, 'FlgoAylUv1ilx1SAtxSyBCJF3bwb'),
       ('72', '21', 'http://xxx.cdn.com/', '1024', '683', null, 'FnuOFbFtDYTbpPdFoZthR-R0tszC'),
       ('73', '21', 'http://xxx.cdn.com/', '455', '683', null, 'FhCiRnyCDQ-O6pXusu5ftmZkIh0-'),
       ('74', '20', 'http://xxx.cdn.com/', '1024', '683', null, 'FvVqU8LneZZ5xaLBAOM1KXR2Pz1X'),
       ('75', '20', 'http://xxx.cdn.com/', '1024', '683', null, 'FtNl9uPM6p5PjEs8z2FnOuViNtOM'),
       ('76', '18', 'http://xxx.cdn.com/', '1440', '960', null, 'FgcD3BufAprERe5y3Gd-Mezu5VAy'),
       ('77', '18', 'http://xxx.cdn.com/', '1024', '683', null, 'Fl1lNikhmMIecbTn-JTsurxugtFU'),
       ('78', '17', 'http://xxx.cdn.com/', '1024', '683', null, 'FvVHtS1qAApFFh6k5LMDm5tliufK'),
       ('79', '17', 'http://xxx.cdn.com/', '1024', '683', null, 'FpVYJRsLykrBRyUSCEOeqsqWU-bt'),
       ('80', '16', 'http://xxx.cdn.com/', '1024', '683', null, 'Fhysh6EcQ_ZTl-jdGe2zaCFi5Uvm'),
       ('81', '16', 'http://xxx.cdn.com/', '1024', '683', null, 'Fvb9TDMRtl1haBj9gK9C0k43X0u0'),
       ('82', '16', 'http://xxx.cdn.com/', '1024', '683', null, 'FvkO1FFyGbrxCP_1O9tA94u2qvbP'),
       ('83', '15', 'http://xxx.cdn.com/', '1024', '683', null, 'FsxiS6rOTpSg5pK7tv41e8Zpnn_c'),
       ('84', '15', 'http://xxx.cdn.com/', '1024', '683', null, 'FpOKJ2IEmbA1y1RbIqgZfqFKkJyS'),
       ('85', '15', 'http://xxx.cdn.com/', '1440', '960', null, 'Fhxz_c16YmEmIz5UVxrp6ihwbvCk');
...
VALUES ('9', '17', '1', null, '3', '2017-11-26 11:06:23', '2023-05-02 09:21:01', '2023-05-03 00:00:00', '13888888888',
        '2');
...
CREATE TABLE `user`
(
    `id`               int(11) unsigned NOT NULL COMMENT '用户唯一id',
...
INSERT INTO `user` (id, name, email, phone_number, password, status, create_time, last_login_time, last_update_time,
                    avatar)
values (1, 'test', 'test@qq.com', '13100000000', '{noop}123456', 1, now(), NULL, now(), '');
